  ...
  <body>
	<div class="panel admin-panel">
      <div class="panel-head">
        <strong class="icon-reorder">列表</strong></div>
         <!-- <a href="/admin.php/Admin/Member/daochu"><strong class="icon-reorder" style="float: right;margin-top: -30px;">导出今日Excel</strong></div></a>
        <a href="/admin.php/Admin/Member/daochus"><strong class="icon-reorder" style="float: right;margin-right: 150px;margin-top: -30px;">导出本月所有记录</strong></div></a> -->
