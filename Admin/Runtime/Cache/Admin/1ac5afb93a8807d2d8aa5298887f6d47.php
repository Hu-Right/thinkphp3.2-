        ...
        <ul class="search">
          ...
          <li>
            ...
            <form method="get" action="">
              ...
              <button type="button" class="button border-yellow" onclick="window.location.href='/admin.php/Admin/Goods/add'">
      ...
      <form method="post" action="/admin.php/Admin/Goods/bdel">
        ...
        <table class="table table-hover text-center">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($v["dkey"]); ?></td>

              <td><?php echo ($v["did"]); ?></td>

              <td><?php echo ($v["dvalue"]); ?></td>

              <td><?php echo ($v["is_hide"]); ?></td>

              <td>

                <div class="button-group">

                  <a class="button border-main" href="/admin.php/Admin/Goods/save/id/<?php echo ($v['id']); ?>">

                    <span class="iconfont icon-icon-xiugai"></span>修改</a>

                  <a class="button border-red" href="/admin.php/Admin/Goods/del/id/<?php echo ($v['id']); ?>" onclick="return del(1)">
