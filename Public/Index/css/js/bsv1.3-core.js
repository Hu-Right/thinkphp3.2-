	...
	return me ={
		 ...
		 bindTheme:function(){
			 ...
			 $("a",themsSetting).click(function(){
					...
					var h = $(window).height();
					var w = $(window).width();
					$("#zoomWallpaper").attr("src","/Public/Index/css/images/bg/"+src+".jpg").width(w).height(h);
...
//初始化分页箭头
Arrows = function(){
	var arrows_l = "<div id='arrows_l' class='arrows'><img src='/Public/Index/css/images/arrows_l_3.png' /></div>";
	var arrows_r = "<div id='arrows_r' class='arrows'><img src='/Public/Index/css/images/arrows_r_1.png' /></div>";
	return arrows = {
		init:function(){
			arrows.create();
			arrows.setPosition();
		...
		changeStyle:function(t,c){
			...
			if(t>1 && t<DATA.menu.length){
				$("#arrows_l img").attr("src","/Public/Index/css/images/arrows_l_1.png");
				$("#arrows_r img").attr("src","/Public/Index/css/images/arrows_r_1.png");
			}
			if(t==1){
				$("#arrows_l img").attr("src","/Public/Index/css/images/arrows_l_3.png");
				$("#arrows_r img").attr("src","/Public/Index/css/images/arrows_r_1.png");
			}
			if(t==DATA.menu.length){
				$("#arrows_l img").attr("src","/Public/Index/css/images/arrows_l_1.png");
				$("#arrows_r img").attr("src","/Public/Index/css/images/arrows_r_3.png");
			}
		}
	}
}();
	...
	var _folder = "<div id=\"folder\"><a href=\"#\">"+
   		"<div id=\"folder_content\">"+
			"<div id=\"min_icon_folder\">"+
            	"<img width=\"32\" height=\"32\" border=\"0\" src=\"/Public/Index/css/icon/min/folder_o.png\" />"+
        	"</div>"+
	...
	return file = {
		...
		bindStyle:function(){
			$("#folder").mouseenter(function(){
				$("#folder").css({"background-image": "url(/Public/Index/css/images/bg_task_group_t_over.png)"});
			});
			$("#folder").mouseleave(function(){
				$("#folder").css({"background-image": "url(/Public/Index/css/images/bg_task_group_t_msg.png)"});
			});
...
Task = $.Class({
	...
	create:function(op)	{
		...
		$("<img src='/Public/Index/css/icon/"+op.icon+"'/><div class='taskItemIconState'></div>").appendTo(taskItemIcon);//图片路径---------------------------------
		var taskItemTxt  = $("<div>",{
			"class":"taskItemTxt",
			text : op.title
		});
	...
	return me = {
		...
		bindStyle:function(){
			$(".sonfile").mouseenter(function(){
				$(this).css({"background-image": "url(/Public/Index/css/images/bg_task_group_t_over.png)"});
			});
			$(".sonfile").mouseleave(function(){
				$(this).css({"background-image": "url(/Public/Index/css/images/bg_task_group_t.png)"});
			});
		},
		bindEvent:function(id){
			$(".sonMenuList").bind("mouseenter",function(){
				$(this).css({"background-image": "url(/Public/Index/css/images/appbutton_mouseover_bg3.png)"});
			});
			...
			$(".sonMenuList").click(function(){
				var _this = $(this);
			 	...
			 	var icon =_this.find("img").attr("src").split("/")[5];
				var sonMenu = "[]";
			...
			if(taskItem.length==1){
				...
				var sonfile = "<a id=\"sonfile_a"+id+"\" href=\"#\">"+
					"<div id=\"sonfile_"+id+"\" class=\"sonfile\">"+
						"<div class=\"min_icon_sonfolder\">"+
							"<img width=\"32\" height=\"32\" border=\"0\" src=\"/Public/Index/css/icon/min/"+icon+"\" />"+
						"</div>"+
				...
				if(jsonSonMenu.length>0){
					...
					for(var i=0;i<jsonSonMenu.length;i++ ){
						...
						sonlist += "<div id=\""+ jsonSonMenu[i].appid+"\" "+ properties +" class=\"sonMenuList\" align=\"center\">"+
							"<a href=\"#\"><div class=\"sonMenuListIocn\">"+
								"<img width=\"64\" height=\"64\" src=\"/Public/Index/css/icon/"+jsonSonMenu[i].icon+"\" />"+
								"</div>"+
					...
					var _box ="<div id=\"sonMenu_box"+id+"\" class=\"sonMenuListBox\"><div class=\"sonMenu_line\">"+
						"<span class=\"sonMenu_font\">应用</span></div>"+"<div class=\"sonitems\">"+sonlist+"</div></div>";
...
appIcon_t1 = appIcon_t0.extend({		
	...
	create:function(fid){
		...
		appIcon.append($("<img>",{
			alt:this.app.name ,
			src:'/Public/Index/css/icon/'+this.app.icon,//图片路径-------------------------------------------------------------------------------------------
...
appIcon_t2 = appIcon_t0.extend({
	...
	create : function(){
		...
		appIcon.append($("<img>",{
			alt:this.sApp.name ,
			src:'/Public/Index/css/icon/'+this.sApp.icon,
			"class":"appButton_appIconImg",
...
mouseStyle = function(){//箭头样式
	$("#arrows_l").mouseenter(function (){
		if(thisPage==1){
			...
			$("#arrows_l img").attr("src","/Public/Index/css/images/arrows_l_2.png");
		}
	});
	$("#arrows_r").mouseenter(function (){
		if(thisPage==DATA.menu.length){
			...
			$("#arrows_r img").attr("src","/Public/Index/css/images/arrows_r_2.png");
		}
	});
