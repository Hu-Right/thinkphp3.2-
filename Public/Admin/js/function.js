...
function chart(obj,type,categories,data,showInLegend,size){
  if(type=='pie'){
    ...
    $('#'+obj).highcharts({
      ...
      tooltip:{formatter: function(){return '<b>' + this.point.name + '</b>:  ' + this.point.y + '美金(' + parseFloat(this.percentage).toFixed(2) + '%)'}},
    ...
    $('#'+obj).highcharts({
      chart:{type:type},
      title:{text:''},
      tooltip:{formatter: function() {return '<b>' + this.series.name + '</b>: '+ this.point.y + '美金'}},
